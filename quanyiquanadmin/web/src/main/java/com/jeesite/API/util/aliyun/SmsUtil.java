package com.jeesite.API.util.aliyun;
...
public class SmsUtil {
    ...
    //餐厅预订 通知管理员
    //public static final String SMS_CODE_CTYD = "SMS_179285407";
    public static final String SMS_CODE_CTYD = "SMS_171355545";
    ...
    public static SendSmsResponse sendSms2(String smsCode, String phone,Map map) throws ClientException {
        //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.client.defaultReadTimeout", "10000");
