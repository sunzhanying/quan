 ...
 */
package com.jeesite.modules.bright.test.web;
...
import com.jeesite.modules.bright.test.service.TestDataService;
...
public class DemoController extends BaseController {
	...
	public String dataGrid(@PathVariable String viewName, TestData testData, Model model) {
		return "modules/bright/demo/demoDataGrid" + StringUtils.cap(viewName);
	}
	...
	public String form(@PathVariable String viewName, TestData testData, Model model) {
		return "modules/bright/demo/demoForm" + StringUtils.cap(viewName);
	}
